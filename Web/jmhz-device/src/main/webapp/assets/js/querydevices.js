/**
 * Created by fjmjuhqc on 2015/10/14.
 */
...
function deviceList(){
    ...
    $(grid_selector).jqGrid({
        url : path+"/devicemg/getAlldevice",
        datatype: "json",
        mtype: "GET",
        height: 372,
        colNames: ['ID', '设备名字', '设备类型', '设备品牌', '购入价格', '购买时间', '所在位置', '使用者', '设备状态', '设备其他信息','编辑'],
        colModel: [
            ...
            {name: 'deviceType', index: 'deviceType', width: 22, editable: true, editable: false},
            {name: 'brand', index: 'brand', width: 22, editable: true, editable: false},
            {name: 'price', index: 'price', width: 22, editable: true, editable: false},
            {name: 'buyTime', index: 'buyTime', width: 22, editable: true, editable: false},
            {name: 'position', index: 'position', width: 30, sorttype: "int", editable: false},
            {name: 'deviceUser', index: 'deviceUser', width: 30, sorttype: "int", editable: false},
            {name: 'status', index: 'status', width: 25, sorttype: "int", editable: false},
            {name: 'configinfo', index: 'configinfo', width: 25, sorttype: "int", editable: false},
            {
        ...
        editurl: path+"/devicemg/modify",//nothing is saved
        caption: "设备信息",
        autowidth: true,
