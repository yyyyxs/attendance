...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form name="usercard" id="usercard" action="${ctx}/farmer/addMqcard" method="post">
                        <table class="table table-bordered sima-custom-table">
                            <tbody>
                            <tr>
                                <td class="center " colspan="6">
                                    <h1 style="margin-top:10px;">${user.username} 用 户 信 息 卡</h1>
                            ...
                            <tr>
                                ...
                                <td class="center col-sm-1">
                                    <input class="form-control input-mask-date" type="text" name="username" id="username" value="${user.username}">
                                </td>
