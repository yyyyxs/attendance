            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form name="upgradeDeviceLog" id="upgradeDeviceLog">
                                    <table class="table table-bordered sima-custom-table">
                                        <tbody>
                                        <tr>
                                            <td class="center " colspan="8">
                                                <h1 style="margin-top:10px;">升级报告</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="deviceName"
                                                       id="deviceName" value="${log.deviceName}">
                                            </td>
                                        </tr>
                                        <td class="center col-sm-1">
                                            设备类型
                                        ...
                                        <td>
                                            <input type="text" name="deviceUser"
                                                   id="deviceUser" value="${log.deviceUser}">
                                        </td>
                                        <tr>
                                            <td class="center col-xs-2" rowspan="2">升级信息</td>
                                            <td class="center col-sm-1">升级状态</td>
                                            <td class="center col-sm-1">
                                                <select class="form-control" name="dealStatus" id="dealStatus">
                                                    <c:choose>
                                                        <c:when test="${log.dealStatus == 0}">
                                                            <option value="0" selected="selected">未升级</option>
                                                            <option value="1">升级中</option>
                                                            <option value="2">已升级</option>
                                                        </c:when>
                                                        <c:when test="${log.dealStatus == 1}">
                                                            <option value="0">未升级</option>
                                                            <option value="1" selected="selected">升级中</option>
                                                            <option value="2">已升级</option>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <option value="0">未升级</option>
                                                            <option value="1">升级中</option>
                                                            <option value="2" selected="selected">已升级</option>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </select>
                                            </td>
                                            <td class="center">升级部件</td>
                                            <td class="center" colspan=2>
                                            <textarea name="upgradepart" class="form-control"
                                                      id="upgradepart" placeholder="升级设备的哪些部件">${log.upgradepart}</textarea>
                                            </td>
                                        ...
                                        <td>
                                            <input type="text" name="cost"
                                                   id="cost" placeholder="升级设备所花金额" value=${log.cost}>
                                        </td>
                                        <td class="center">升级结果</td>
                                        <td class="center" colspan="4">
                                                <textarea name="upgradeResult" id="upgradeResult"
                                                          class="form-control" style="height: 80px;"
                                                          placeholder="设备升级结果描述以及备注">${log.upgradeResult}</textarea>
                                        </td>
