                                    ...
                                    <table class="table table-bordered sima-custom-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center" colspan="4">
                                                 <textarea name="upgradeDescribe" class="form-control"
                                                           id="upgradeDescribe" placeholder="请详细描述需要升级的地方"
                                                           style="width:800px;height:100px">${apply.upgradeDescribe}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
...
<script src="${ctx}/assets/js/upgrademodifyapply.js" type="text/javascript"></script>
<script>
    jQuery(function ($) {
        //权限控制，镇级账号
