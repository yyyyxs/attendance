            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form name="upgradeLog" id="upgradeLog">
                                    <table class="table table-bordered sima-custom-table">
                                        ...
                                        <tr>
                                            ...
                                            <textarea name="upgradepart" class="form-control"
                                                      id="upgradepart" placeholder="升级设备的哪些部件"></textarea>
                                            </td>
...
<%--<script src="${ctx}/assets/js/upgradeLogAdd.js" type="text/javascript"></script>--%>
<script src="${ctx}/assets/js/upgradeLogAdd.js" type="text/javascript"></script>
<!-- inline scripts related to this page -->
