...
<head>
    <meta charset="utf-8"/>
    <title><spring:message code="global.navMenu.smAppeal" /> - <spring:message code="global.subMenu.smAppealMark" /></title>
...
<script src="${ctx}/assets/js/pages/appealmark/smhlmarkListFun.js"></script>
</body>
</html>
