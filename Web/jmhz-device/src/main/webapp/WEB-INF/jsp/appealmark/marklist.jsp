...
<head>
    <meta charset="utf-8"/>
    <title><spring:message code="global.subMenu.appealView" /> - <spring:message code="global.subMenu.appealMark" /></title>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><spring:message code="global.subMenu.appealMark" /></li>
                </ul>
                <!-- .breadcrumb -->
            </div>
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <div id="tableDiv">
                            <input id="appealid" name="appealid" hidden="hidden" value="${appealid}">
                            <!--This is the table.-->
...
<!-- /.main-container -->
    ...
    <script src="${ctx}/assets/js/pages/appealmark/markListFun.js"></script>
</body>
</html>
