    ...
    <div class="navbar navbar-default" id="navbar">
        ...
        <script type="text/javascript">
            $(function($) {
                ...
                //alert(uuid+"|"+name+"|"+tel);
                var condition = uuid+","+name+","+tel;
                //alert("${ctx}/farmer/queryspecialfamily/"+specialfamilyValue+"/&time="+Date.parse(new Date()));
                var grid_selector = "#grid-table";
                var pager_selector = "#grid-pager";

                $(grid_selector).jqGrid({
                    url : "${ctx}/masses/queryMassesAppeal/"+condition,
                    datatype: "json",
                    mtype: "GET",
                    height: 372,
                    colNames:['诉求编号','诉求编号','诉求来源','诉求方','诉求类别','事务类别','状态','责任领导','责任部门','责任人','完成时限','诉求管理'],
                    colModel:[

                        {name:'id',index:'id', width:50, sorttype:"int", editable: false, hidden: true},
                        {name:'uuid',index:'uuid', width:90, sorttype:"int", editable: false},
                        {name:'proposer',index:'proposer', width:50, editable: false , formatter: styleProposer},
                        ...
                        {name:'affairtype',index:'affairtype', width:60 , editable: false, formatter: styleAffairType},
                        ...
                        {name:'',index:'hardshipappeal', width:60, sorttype:"int", editable: false,
                            formatter: makeURL}
                    ],
                    viewrecords : true,
                    rowNum:10,
                ...
                function makeURL(cellvalue, options, rowObject) {
                    ...
                    var urlstring;
                    urlstring = "<a href='${ctx}/masses/toviewpage/"+rowObject["id"]+"'>"+"详细内容"+"</a>";
                    return urlstring;
                }
                ...
                function reloadList(grid_selector) {
                    ...
                    $(grid_selector).jqGrid("setGridParam", {
                        url: "${ctx}/masses/queryMassesAppeal/"+condition, //设置表格的url
