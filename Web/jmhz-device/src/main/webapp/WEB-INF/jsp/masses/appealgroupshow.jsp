        ...
        <form name="mqcard" id="mqcard">
            <table class="table table-bordered sima-custom-table" style="margin-bottom: 0px;border-bottom: 0px;">
                ...
                <tr>
                    ...
                    <td><input class="input-large" type="text" name="uuid" id="uuid" value="${appeal.uuid}" readonly="readonly"></td>
                    <td colspan="4"></td>
                </tr>
                <tr>
                    ...
                    <td class="center col-sm-2">
                        <input class="input-large" type="text" name="groupchargername" id="groupchargername" value="${group.groupchargername}"
                               readonly="readonly">
                    ...
                    <td class="center col-sm-4">
                        <input class="input-large" type="text" name="groupchargertel" id="groupchargertel" style="float: left"
                               value="${group.groupchargertel}" readonly="readonly">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="center" colspan="5" style="border-bottom: 0px;">
                        <textarea name="hardshipappeal" id="hardshipappeal" class="form-control" style="height: 80px;"
                                  readonly="readonly">${appeal.hardshipappeal}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
            <table class="table table-bordered sima-custom-table">
                ...
                <tr>
                    ...
                    <td class="center" colspan="5">
                        <textarea name="solution" id="solution" class="form-control" style="height: 80px;"
                                  readonly="readonly"> ${appeal.solution}</textarea>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="center col-sm-2">
                        <select class="form-control" name="status" id="status" disabled="disabled">
                            ...
                            <option value="1">以上报上级协调解决</option>
