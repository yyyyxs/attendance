...
<html lang="en">
    ...
    <body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="padding-top:5px;">
                                            <label>
                                                <input name="housingsituation" class="ace ace-checkbox-1" type="checkbox"
                                                       id="t0" value="0">
        ...
        <script type="text/javascript">
            $(function($) {
                var housingsituationValue = '';
                $('input[name="housingsituation"]:checked').each(function(){
                    housingsituationValue = housingsituationValue + $(this).val() + ',';
                });
                ...
                $(grid_selector).jqGrid({
                    url : "${ctx}/farmer/queryhousingsituation/"+housingsituationValue+"/"+Date.parse(new Date()),
                    datatype: "json",
                    mtype: "GET",
                    height: 372,
                ...
                function reloadList(grid_selector) {
                    ...
                    //alert(housingsituationValue);
                    $(grid_selector).jqGrid("setGridParam", {
                        url: "${ctx}/farmer/queryhousingsituation/"+housingsituationValue, //设置表格的url
