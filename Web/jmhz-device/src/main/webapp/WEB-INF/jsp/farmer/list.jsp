        ...
        <script type="text/javascript">
            ...
            $(function($) {
                ...
                $(grid_selector).jqGrid({
                    ...
                    mtype: "GET",
                    height: 372,
                    colNames: ['id', '姓名', '性别', '出生年月', '所属镇', '所属村', '网格', '政治面貌', '联系号码', '走访时间列表', '编辑'],
                    colModel:[
                        ...
                        {name:'visittime',index:'visittime', width:40, formatter: styleVisitTime},
                ...
                function styleVisitTime (cellvalue, options, rowObject) {
                    var urlstring =
                            ...
                            "<button title=\"查看走访时间列表\" class=\"btn btn-xs btn-info\" style=\"margin: 0;margin-left:10px;\" id=\"changePwd\" onclick =\"window.open('${ctx}/farmerVisit/getVisitList/" + rowObject["id"] + "','_blank')\">" +
