...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="col-xs-8">
                                <form name="sendSingleSMS" id="sendSingleSMSForm">
                                    <table class="table table-bordered sima-custom-table">
                                        ...
                                        <tr>
                                            <td class="center col-xs-1">手机端ChannelId</td>
                                            <td class="center col-sm-1">
                                                <input class="input-medium" type="text" name="channelId" id="channelId" style="width: 100%">
                                            </td>
                                            <td class="center col-sm-1">手机端UserId</td>
                                            <td class="center col-xs-1">
                                                <input class="input-medium" type="text" name="userId" id="userId" style="width: 100%">
                                            </td>

                                        </tr>
                                        <tr>
                                            <td class="center col-sm-1">消息标题</td>
                                            <td class="center col-sm-1" colspan="3">
                                        ...
                                        <tr>
                                            <td colspan="6" class="center">
                                                <button type="button" class="btn btn-info" id="pushSingleMessageBtn">
        ...
        <script type="text/javascript">
            //发送短信
            $("#pushSingleMessageBtn").click(function(){
                $.ajax({
                    type: "POST",
                    url: "${ctx}/push/single",
                    data: {
