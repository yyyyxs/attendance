                    ...
                    <form name="" action="" method="post">
                        <table class="table table-bordered sima-td-input-100" style="margin-bottom: 0;">
                            <tbody>
                                ...
                                <tr>
                                    <td class="center" colspan="2"><label for="villageName"><b>村名：</b></label></td>
                                    <td colspan="11"><input type="text" name="villageName" id="villageName"></td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-bordered sima-td-input-100" style="margin-bottom: 0;">
                            ...
                            <tr>
                                ...
                                <td style="border-top:0; width: 6%; padding: 1px; margin: 0;">
                                    <input type="text" name="primaryIndPepCnt" id="primaryIndPepCnt"></td>
                                <td style="border-top:0; width: 6%; padding: 1px; margin: 0;">
