                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="" id="modifyRoleDiv">
                            ...
                            <div class="space-10"></div>
                            <form class="form-horizontal" action="${ctx}/smstpl/update/${tsmstemplate.id}"
                                  method="post" id="updateSMSTemplateForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea id="tplcontent" name="tplcontent" class="col-sm-5"
                                                  style="height: 120px;padding: 5px;">${tsmstemplate.tplcontent}</textarea>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        $("#tplname").find("option[value=${tsmstemplate.tplname}]").attr("selected", "selected");
        if (${tsmstemplate.isvalid}) {
