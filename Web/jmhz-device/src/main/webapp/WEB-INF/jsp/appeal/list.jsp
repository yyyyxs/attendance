...
<html lang="en">
    ...
    <body>
        ...
        <%--<script src="${ctx}/assets/js/pages/appeal/appealListFun.js" type="text/javascript"></script>--%>
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $(grid_selector).jqGrid({
                url: path + "/appeal/getAllAppeal/${source}",
                datatype: "json",
                mtype: "GET",
                height: 'auto',
                colNames: ['诉求编号', '诉求编号', '诉求来源', '诉求方', '所属镇', '所属村', '诉求类别', '事务类别', '状态', '责任领导', '责任部门', '责任人', '创建日期', '完成时限', '诉求操作'],
                colModel: [
