...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><spring:message code="global.navMenu.group" /> - <spring:message code="global.subMenu.groupView" /></title>
                ...
                <div class="main-content">
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><spring:message code="global.subMenu.groupView" /></li>
                        </ul><!-- .breadcrumb -->
                    </div>
        ...
        <script type="text/javascript">
            $(function($) {
                ...
                $(grid_selector).jqGrid({
                    ...
                    mtype: "GET",
                    height: 372,
                    colNames:['ID','县名','镇名','集体名称','集体负责人','负责人联系号码','编辑'],
                    colModel:[

                        {name:'id',index:'id', width:60, sorttype:"int", editable: false},
                        {name:'city',index:'city',width:90, sorttype:"textarea", editable: true},
                        {name:'town',index:'town',width:90, sorttype:"textarea", editable: true},
                        {name:'groupname',index:'groupname',width:90, editable:true, sorttype:"textarea"},
                        {name:'groupchargername',index:'groupchargername', width:90,editable: true  },
                        {name:'groupchargertel',index:'groupchargertel', width:90, sorttype:"int", editable: true},
                    ...
                    editurl: "${ctx}/group/modify",//nothing is saved
                    caption: "<spring:message code="global.subMenu.groupView" />",
                    autowidth: true,
                ...
                function makeURL(cellvalue, options, rowObject) {
                    ...
                    var urlstring;
                    urlstring = "<a href='${ctx}/group/toviewpage/"+rowObject["id"]+"'>"+cellvalue+"</a>";
                    return urlstring;
                }
