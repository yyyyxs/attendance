...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form name="groupAddForm" id="groupAddForm">
                        <table class="table table-bordered sima-custom-table">
                            ...
                            <tr>
                                <td class="center col-xs-1" colspan="2">诉求编号：
                                    <input class="input-large" type="text" name="uuid" id="uuid" value="${appeal.uuid}"></td>
                            </tr>
                            <tr>
                                <td class="center col-xs-1">集体名称</td>
                                <td class="center col-sm-2">
                                    <input class="input-large" type="text" name="groupname" id="groupname" value="${verifyName}">
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="center">
                                    ...
                                    <button class="btn btn-info" id="updateGroupAppealBtn">
...
<script src="${ctx}/assets/js/groupAdd.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        //权限控制，镇级账号
        <c:if test="${user.auth_level != 2}">
        document.getElementById("updateGroupAppealBtn").disabled = true;
        </c:if>
    });
...
<c:if test="${verifyRes == 0}">
    <script>
        bootbox.dialog({
            message: "<span class='bigger-110'>该集体用户不存在，跳转集体添加界面！</span>",
            buttons:
            {
                "success" :
                {
