            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form name="deviceShow" id="deviceShow" action="${ctx}/equipment/update" method="post">
                                    <table class="table table-bordered sima-custom-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center col-sm-2" colspan="2">
                                                <input class="date-picker col-xs-12" id="buyTime" name="buyTime"
                                                       type="text" data-date-format="yyyy-mm-dd"
                                                       value="${device.buyTime}" readonly="true">
                                            </td>

                                        </tr>
                                        <td class="center col-sm-1" colspan="1">所在地点</td>
                                        <td class="center col-sm-2" colspan="2">
                                            <select class="form-control" name="position" id="position">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        ...
                                                        <option value="1">302</option>
                                                        <option value="2">303</option>
                                                        <option value="3" selected="selected">305</option>
                                                    </c:otherwise>
                                                </c:choose>
                                            </select>
                                        </td>
                                        ...
                                        <td class="center col-sm-2" colspan="2">
                                            <input class="form-control" type="text" name="deviceUser"
                                        ...
                                        <tr>
                                            ...
                                            <td class="center col-sm-2" rowspan="2" colspan="2">
                                                <input class="form-control" type="text" name="brand"
                                                       id="brand" value="${device.brand}"readonly="true">
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="11" class="center">
                                               <%-- <a href="javascript:history.back(-1)" class="btn btn-grey"> <i
                                                ...
                                                <button class="btn btn-info" id="updateDeviceBtn">
