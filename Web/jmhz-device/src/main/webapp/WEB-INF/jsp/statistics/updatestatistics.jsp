...
<script>
    ...
    $(function () {
        ...
        var data = [
            { label: "未升级", data: ${unsolvedCount}, color: unsolvedColor},
            { label: "正在升级", data: ${doingCount}, color: doingColor},
            { label: "已升级", data: ${finishCount}, color: finishColor}
        ];
