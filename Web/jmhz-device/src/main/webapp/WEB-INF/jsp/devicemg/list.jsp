        ...
        function makeURLForOperation(cellvalue, options, rowObject) {
            var urlstring =
                    ...
                    "<button title=\"设备申请升级\" class=\"btn btn-xs btn-grey\" style=\"margin: 0;margin-left:10px;\" id=\"changePwd\" " +
                        /*"<div class=\"btn-group\" id='operationBtns'>" +
                         "<a title=\"查看详情\" class=\"btn btn-xs btn-danger\"  style=\"margin: 0;margin-left:10px;\" " +
                         "id=\"checkIcon\" href='${ctx}/Upgrade/upgrade/"+rowObject["id"]+"' target='_blank'>" +
                     "<i class=\"icon-search bigger-120\" style=\"margin: 0;\" ></i></a>" +
                     "</div>";*/
