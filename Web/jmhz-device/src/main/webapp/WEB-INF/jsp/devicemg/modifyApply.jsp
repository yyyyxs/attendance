                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form name="faultApply" id="faultApply">
                                    <table class="table table-bordered sima-custom-table">
                                        <tbody>
                                        <tr>
                                            <td class="center " colspan="6">
                                                <h1 style="margin-top:10px;">故障申报</h1>
                                                <%--  <c:choose>
                                                      <c:when test="${source == 0}">
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <input class="input-medium" type="hidden" name="deviceId" id="deviceId"
                                        ...
                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border-top:0;">
                                                            <select class="form-control" name="deviceType"
                                                                    id="deviceType" disabled="disabled">
                                            ...
                                            <td class="center" colspan="4">
                                                 <textarea name="faultDescribe" class="form-control"
                                                           id="faultDescribe" placeholder="请详细描述需要维修的地方"
                                                           style="width:800px;height:100px">${apply.faultDescribe}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="1" class="center"> 审核意见</td>
                                            <td class="center" colspan="5">
                                            <textarea name="approveRemark" class="form-control"
                                                      id="approveRemark"
                                                      disabled="disabled">${apply.approveRemark}</textarea>
                                            </td>

                                        </tr>
                                        <input name="id" type="hidden" id="id" value=${apply.id}>
                                        <input name="approve" type="hidden" id="approve" value=${apply.approve}>
                                        <input name="status" type="hidden" id="status" value=${apply.status}>
                                        <tr>
...
<script src="${ctx}/assets/js/modifyapply.js" type="text/javascript"></script>
<script>
    jQuery(function ($) {
        //权限控制，镇级账号
