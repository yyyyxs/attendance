...
public class LogUtils {
    ...
    public static final Logger INFO_LOG = LoggerFactory.getLogger("sima-info");
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("sima-error");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("sima-access");

    public static void logInfo(String message) {
        StringBuilder s = new StringBuilder();
        s.append(getBlock(message));
        ERROR_LOG.info(s.toString());
    }
