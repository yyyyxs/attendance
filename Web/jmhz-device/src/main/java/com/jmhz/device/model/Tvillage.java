...
public class Tvillage implements Serializable{
    ...
    public Tvillage(int id, String city, String town, String village, String villagerTeam, String households, String totalPepCnt, String totalPepMan, String totalPepWoman, String belowEighteen, String belowSixty, String aboveSixty, String mainNation, String nationPeps, String otherNation, String otherPeps, String partyGroupCnt, String partyMemCnt, String hometownRemain, String fiveGuarantees, String lowIncome, String poorFamily, String totalCultArea, String perCultArea, String forestArea, String fruitArea, String bambooArea, String landCycleCond, String primaryIndValue, String primaryIntPepCnt, String secondIndValue, String secondIndPepCnt, String thirdIndValue, String thirdIndPepCnt, String snackHouseholds, String snackPepCnt, String snackIncome, String coopPlant, String coopBreed, String coopAgro, String coopOther, String otherFamily, String totalIncome, String perFarmerIncome, String villageOrgArea, String farmerFitWeap, String farmerFitArea, String elderRoomArea, String healthRoomArea, String healthRoomBeds, String eduPotTeachers, String eduPotStudents, String kidTeachers, String kidStudents, String vilTotalIncome, String vilTotalAssets, String vilTotalDebts, String twoCommitsCnt, String vilRepresentCnt) {
        this.id = id;
        this.city = city;
        this.town = town;
    ...
    public String toString() {
        return "Tvillage{" +
                ...
                ", town='" + town + '\'' +
                ", village='" + village + '\'' +
                ", villagerTeam='" + villagerTeam + '\'' +
                ", households='" + households + '\'' +
                ", totalPepCnt='" + totalPepCnt + '\'' +
                ", totalPepMan='" + totalPepMan + '\'' +
                ", totalPepWoman='" + totalPepWoman + '\'' +
                ", belowEighteen='" + belowEighteen + '\'' +
                ", belowSixty='" + belowSixty + '\'' +
                ", aboveSixty='" + aboveSixty + '\'' +
                ", mainNation='" + mainNation + '\'' +
                ", nationPeps='" + nationPeps + '\'' +
                ", otherNation='" + otherNation + '\'' +
                ", otherPeps='" + otherPeps + '\'' +
                ", partyGroupCnt='" + partyGroupCnt + '\'' +
                ", partyMemCnt='" + partyMemCnt + '\'' +
                ", hometownRemain='" + hometownRemain + '\'' +
                ", fiveGuarantees='" + fiveGuarantees + '\'' +
                ", lowIncome='" + lowIncome + '\'' +
                ", poorFamily='" + poorFamily + '\'' +
                ", totalCultArea='" + totalCultArea + '\'' +
                ", perCultArea='" + perCultArea + '\'' +
                ", forestArea='" + forestArea + '\'' +
                ", fruitArea='" + fruitArea + '\'' +
                ", bambooArea='" + bambooArea + '\'' +
                ", landCycleCond='" + landCycleCond + '\'' +
                ", primaryIndValue='" + primaryIndValue + '\'' +
                ", primaryIntPepCnt='" + primaryIntPepCnt + '\'' +
                ", secondIndValue='" + secondIndValue + '\'' +
                ", secondIndPepCnt='" + secondIndPepCnt + '\'' +
                ", thirdIndValue='" + thirdIndValue + '\'' +
                ", thirdIndPepCnt='" + thirdIndPepCnt + '\'' +
                ", snackHouseholds='" + snackHouseholds + '\'' +
                ", snackPepCnt='" + snackPepCnt + '\'' +
                ...
                ", perFarmerIncome='" + perFarmerIncome + '\'' +
                ", villageOrgArea='" + villageOrgArea + '\'' +
                ", farmerFitWeap='" + farmerFitWeap + '\'' +
                ", farmerFitArea='" + farmerFitArea + '\'' +
                ", elderRoomArea='" + elderRoomArea + '\'' +
                ", healthRoomArea='" + healthRoomArea + '\'' +
                ", healthRoomBeds='" + healthRoomBeds + '\'' +
                ", eduPotTeachers='" + eduPotTeachers + '\'' +
                ", eduPotStudents='" + eduPotStudents + '\'' +
                ", kidTeachers='" + kidTeachers + '\'' +
                ", kidStudents='" + kidStudents + '\'' +
                ", vilTotalIncome='" + vilTotalIncome + '\'' +
                ", vilTotalAssets='" + vilTotalAssets + '\'' +
                ", vilTotalDebts='" + vilTotalDebts + '\'' +
                ", twoCommitsCnt='" + twoCommitsCnt + '\'' +
                ", vilRepresentCnt='" + vilRepresentCnt + '\'' +
                '}';
    }
}
