...
//        //获取公开诉求信息
//        List<Tappeal> tappeals = appealService.getPublicAppeal();
//        if (tappeals.size()%2 == 1){
//            tappeals.add(tappeals.get(0));
//        }
////        for (int i = 0; i < tappeals.size(); i++) {
////            tappeals.get(i).setAppealtype(AppealUtils.getAppealTypeByCode(tappeals.get(i).getAppealtype()));
////            tappeals.get(i).setAffairtype(AppealUtils.getAffairTypeByCode(tappeals.get(i).getAffairtype()));
////            tappeals.get(i).setStatus(AppealUtils.getStatusTypeByCode(tappeals.get(i).getStatus()));
////        }
//        model.addAttribute("publicAppeals",tappeals);
        //获取党务公开信息,各13条
//        List<Tsmssent> dwList = smsSentService.getPublicDWForIndex(1, 13);
//        List<Tsmssent> zwList = smsSentService.getPublicZWForIndex(1, 13);
//        for (int i = 0; i < dwList.size(); i++) {
//            String[] parentChildType = SmsQueryTypesConverter.getParentChildType(dwList.get(i).getQrytype());
//            if (StringUtils.isEmpty(dwList.get(i).getParenttype())) {
//                dwList.get(i).setParenttype(parentChildType[0]);
//            }
//            if (StringUtils.isEmpty(dwList.get(i).getChildtype())) {
//                dwList.get(i).setChildtype(parentChildType[1]);
//            }
//        }
//        for (int i = 0; i < zwList.size(); i++) {
//            String[] parentChildType = SmsQueryTypesConverter.getParentChildType(zwList.get(i).getQrytype());
//            if (StringUtils.isEmpty(zwList.get(i).getParenttype())) {
//                zwList.get(i).setParenttype(parentChildType[0]);
//            }
//            if (StringUtils.isEmpty(zwList.get(i).getChildtype())) {
//                zwList.get(i).setChildtype(parentChildType[1]);
//            }
//        }
//        List<Tsmssent> finalList = new ArrayList<Tsmssent>();
//        finalList.addAll(dwList);
//        finalList.addAll(zwList);
//        model.addAttribute("publicDwgk",finalList);
