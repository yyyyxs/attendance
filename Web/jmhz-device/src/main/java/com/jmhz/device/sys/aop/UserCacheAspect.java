 ...
 */
package com.jmhz.device.sys.aop;
...
public class UserCacheAspect extends BaseCacheAspect {
     ...
     * 匹配用户Service
     */
    @Pointcut(value = "target(com.jmhz.device.sys.service.impl.UserServiceImpl)")
    ...
    private String telKey(String email) {
        return telKeyPrefix + email;
    }
