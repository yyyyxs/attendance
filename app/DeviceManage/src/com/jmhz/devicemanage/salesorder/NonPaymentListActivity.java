...
public class NonPaymentListActivity extends Activity implements
		OnItemClickListener, OnScrollListener {
	private ListView mPayments = null;
	private NonPaymentAdapter mAdapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_salas_non_payment_list);
		mPayments = (ListView) findViewById(R.id.non_payment_list);
	...
	private void initListView() throws Exception {
		...
		od.setPaging(p);
		od.setOrderStatus(OrderStatus.NO_PAID.ordinal() + "");
		getList(od);
	...
	private void getList(OrderDetail od) throws Exception {
		new SalesOrderApi(this).getListByStatus(od, new HttpCallback() {
			...
			public void onSuccess(Object o) {
				...
				mAdapter = new NonPaymentAdapter(rowResult,
						NonPaymentListActivity.this);
				mPayments.setOnItemClickListener(NonPaymentListActivity.this);
				mPayments.setOnScrollListener(NonPaymentListActivity.this);
				...
				Toast.makeText(NonPaymentListActivity.this,
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			long arg3) {
		Intent intent = new Intent(NonPaymentListActivity.this,
		...
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
			if (view.getLastVisiblePosition() == view.getCount() - 1) {
				if (rowTotal < pageSize) {
					Toast.makeText(NonPaymentListActivity.this, "没有更多数据！",
							Toast.LENGTH_SHORT).show();
					return;
				}
				...
				if (rowTotal > rowResult.size()) {
					if (!mLoading) {
						...
						Toast.makeText(NonPaymentListActivity.this, "加载中，请稍后！",
								Toast.LENGTH_SHORT).show();
					}
				} else {
					Toast.makeText(NonPaymentListActivity.this, "没有更多数据！",
