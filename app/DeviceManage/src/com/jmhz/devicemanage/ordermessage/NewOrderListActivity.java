...
import com.jmhz.devicemanage.adapter.NewOrderListAdapter;
...
public class NewOrderListActivity extends Activity implements
		OnItemClickListener, OnScrollListener {
	private ListView mNewOrders = null;
	private NewOrderListAdapter mAdapter = null;
	// private int sum = 0;
	...
	private void initListView() throws Exception {
		...
		new OrderMessageApi(this).getOrderMessageList(om, new HttpCallback() {
			...
			public void onSuccess(Object o) {
				...
				mAdapter = new NewOrderListAdapter(rowResult,
						NewOrderListActivity.this);
				mNewOrders.setOnItemClickListener(NewOrderListActivity.this);
				mNewOrders.setOnScrollListener(NewOrderListActivity.this);
				...
				Toast.makeText(NewOrderListActivity.this,
			...
			public void onFail(String errorCode, String errorMsg) {
				...
				Toast.makeText(NewOrderListActivity.this, errorMsg,
	...
	public void onItemClick(AdapterView<?> arg0, View v, int position, long arg3) {
		Intent intent = new Intent(NewOrderListActivity.this,
		...
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
			if (view.getLastVisiblePosition() == view.getCount() - 1) {
				if (rowTotal < pageSize) {
					Toast.makeText(NewOrderListActivity.this, "没有更多数据！",
							Toast.LENGTH_SHORT).show();
					return;
				}
				// 表示说 还有数据
				if (rowTotal > rowResult.size()) {
					if (!mLoading) {
						...
						Toast.makeText(NewOrderListActivity.this, "加载中，请稍后！",
								Toast.LENGTH_SHORT).show();
					}
				} else {
					Toast.makeText(NewOrderListActivity.this, "没有更多数据！",
