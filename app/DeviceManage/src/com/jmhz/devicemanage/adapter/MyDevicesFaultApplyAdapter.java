...
public class MyDevicesFaultApplyAdapter extends BaseAdapter {

	private Context context;
	private List<MyDevicesApplyInfo> applyInfoList = new ArrayList<MyDevicesApplyInfo>();
	private LayoutInflater layoutInflater;

	public MyDevicesFaultApplyAdapter(
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(
					R.layout.mydevice_fault_apply_info, parent, false);
			holder = new ViewHolder();
			holder.tv_apply_device_id = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_device_id);
			holder.tv_apply_device_name = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_device_name);
			holder.tv_apply_device_type = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_device_type);
			holder.tv_apply_device_user = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_device_user);
			holder.tv_apply_time = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_time);
			holder.tv_apply_describe = (TextView) convertView
					.findViewById(R.id.tv_fault_apply_describe);
