...
public class DeviceUpdateNotAuditAdapter extends BaseAdapter {
	
	private Context mContext;
	private List<DeviceUpdateInfo> mDeviceUpdateInfos = new ArrayList<DeviceUpdateInfo>();
	private LayoutInflater mLayoutInflater;
	
	public DeviceUpdateNotAuditAdapter(List<DeviceUpdateInfo> mDeviceUpdateInfos, Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mLayoutInflater.inflate(R.layout.deviceupdate_notaudit_info, parent, false);
			holder = new ViewHolder();
			holder.tv_et_device_num = (TextView) convertView.findViewById(R.id.tv_et_device_num_updatenotaudit);
			holder.tv_et_deivce_name = (TextView) convertView.findViewById(R.id.tv_et_deivce_name_updatenotaudit);
			holder.tv_et_deivce_type = (TextView) convertView.findViewById(R.id.tv_et_deivce_type_updatenotaudit);
			holder.tv_et_deivce_status = (TextView) convertView.findViewById(R.id.tv_et_device_status_updatenotaudit);
			holder.tv_et_device_update_user = (TextView) convertView.findViewById(R.id.tv_et_device_update_user_updatenotaudit);
			holder.tv_et_device_update_applytime = (TextView) convertView.findViewById(R.id.tv_et_device_update_applytime_updatenotaudit);
			holder.tv_et_device_update_reason = (TextView) convertView.findViewById(R.id.tv_et_device_update_reason_updatenotaudit);
			holder.tv_et_device_update_approve = (TextView) convertView.findViewById(R.id.tv_et_device_update_approve_updatenotaudit);
