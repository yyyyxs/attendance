...
import com.jmhz.devicemanage.salesorder.ReceiveListActivity;

public class ReceiveAdapter extends BaseAdapter {

	private ArrayList<PaymentItem> mData = null;
	private ReceiveListActivity mActivity = null;

	public ReceiveAdapter(ArrayList<PaymentItem> mData,
			ReceiveListActivity mActivity) {
		this.mData = mData;
