...
import com.jmhz.devicemanage.stock.OutStockRecodeActivity;
import com.uid.trace.module.stock.schema.InOutStockDetail;

public class OutStockRecordAdapter extends BaseAdapter {

	private ArrayList<InOutStockDetail> mData = null;
	private OutStockRecodeActivity mActivity = null;

	public OutStockRecordAdapter(ArrayList<InOutStockDetail> mData,
			OutStockRecodeActivity mActivity) {
		this.mData = mData;
