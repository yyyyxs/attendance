...
public class NonPaymentAdapter extends BaseAdapter {

	private ArrayList<PaymentItem> mData = null;
	private NonPaymentListActivity mActivity = null;

	public NonPaymentAdapter(ArrayList<PaymentItem> mData,
			NonPaymentListActivity mActivity) {
		this.mData = mData;
