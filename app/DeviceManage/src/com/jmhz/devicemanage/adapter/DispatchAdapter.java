...
import com.jmhz.devicemanage.salesorder.DispatchListActivity;

public class DispatchAdapter extends BaseAdapter {

	private ArrayList<PaymentItem> mData = null;
	private DispatchListActivity mActivity = null;

	public DispatchAdapter(ArrayList<PaymentItem> mData,
			DispatchListActivity mActivity) {
		this.mData = mData;
