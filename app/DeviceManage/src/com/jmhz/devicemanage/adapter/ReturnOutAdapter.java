...
import com.jmhz.devicemanage.stock.ReturnOutListActivity;

public class ReturnOutAdapter extends BaseAdapter {
	private ArrayList<SaleOutItem> mData = null;
	private ReturnOutListActivity mSaleOutListActivity = null;

	public ReturnOutAdapter(ArrayList<SaleOutItem> mData,
			ReturnOutListActivity mSaleOutListActivity) {
		this.mData = mData;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mSaleOutListActivity).inflate(
					R.layout.listview_return_out, null);
