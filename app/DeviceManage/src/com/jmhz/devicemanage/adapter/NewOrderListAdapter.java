...
import com.jmhz.devicemanage.ordermessage.NewOrderListActivity;

public class NewOrderListAdapter extends BaseAdapter {

	private ArrayList<NewOrderItem> mData = null;
	private NewOrderListActivity mActivity = null;

	public NewOrderListAdapter(ArrayList<NewOrderItem> mData,
			NewOrderListActivity mActivity) {
		this.mData = mData;
