...
public class upgradeApply implements Serializable {
    ...
    private String upgradeDescribe;//故障描述
	...
	public upgradeApply(int id, int deviceId, int userId, String deviceName,
			String deviceType, String deviceUser, String applytime,
			String upgradeDescribe, String status, String approve,
			String approveRemark, int logmark) {
		this.id = id;
		this.deviceId = deviceId;
		this.userId = userId;
		this.deviceName = deviceName;
	...
	public String toString() {
		return "device{" + ", id='" + id + '\'' + ", deviceId='" + deviceId
				+ '\'' + ", userId='" + userId + '\'' + ", deviceName='"
				+ deviceName + '\'' + ", deviceType='" + deviceType + '\''
				+ ", deviceUser='" + deviceUser + '\'' + ", applytime='"
				+ applytime + '\'' + ", upgradeDescribe='" + upgradeDescribe
