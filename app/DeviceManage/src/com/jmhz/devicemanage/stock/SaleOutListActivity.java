...
import com.jmhz.devicemanage.adapter.SaleOutAdapter;
...
public class SaleOutListActivity extends Activity implements
	...
	private SaleOutAdapter mSaleOutAdapter = null;
	...
	private void initView() {
		...
		mBtnSignOut.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				dialog = new SaleOutDialog(SaleOutListActivity.this,
						R.style.MyDialog);
				...
				dialog.getWindow().findViewById(R.id.ibtn_delivery_out)
						.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								...
								intent.setClass(SaleOutListActivity.this,
		...
		mBtnSearch.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (TextUtils.isEmpty(mEtContent.getText().toString())) {
					Toast.makeText(SaleOutListActivity.this, "单号为空！", 1).show();
					return;
				}
				...
				Toast.makeText(SaleOutListActivity.this,
						"共" + mSaleOutItems_search.size() + "记录符合", 1).show();
				mSaleOutAdapter = new SaleOutAdapter(mSaleOutItems_search,
						SaleOutListActivity.this);
				mLvSaleOut.setOnItemClickListener(SaleOutListActivity.this);
				mLvSaleOut.setOnScrollListener(SaleOutListActivity.this);
				mLvSaleOut.setAdapter(mSaleOutAdapter);
			}
		});
		mBtnClose.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				mEtContent.setText("");
				mSaleOutAdapter = new SaleOutAdapter(mSaleOutItems,
						SaleOutListActivity.this);
				mLvSaleOut.setOnItemClickListener(SaleOutListActivity.this);
				mLvSaleOut.setOnScrollListener(SaleOutListActivity.this);
				mLvSaleOut.setAdapter(mSaleOutAdapter);
	...
	private void initListView() throws Exception {
		...
		inOutStock.setStockType("1");// 销售出库
			...
			public void onSuccess(Object o) {
				...
				for (InOutStock inOutStock : ioss) {
					SaleOutItem maSaleOutItem = new SaleOutItem(inOutStock.getCid(),inOutStock
							...
							inOutStock.getOrderNumber(), SessionKeeper.getEmail(SaleOutListActivity.this), inOutStock.getCount(),
		...
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
			if (view.getLastVisiblePosition() == view.getCount() - 1) {
				if (rowTotal < pageSize) {
					Toast.makeText(SaleOutListActivity.this, "没有更多数据！", 1)
							.show();
					return;
				}
				...
				if (rowTotal > mSaleOutItems.size()) {
					if (!mLoading) {
						...
						Toast.makeText(SaleOutListActivity.this, "加载中，请稍后！", 1)
								.show();
					}
				} else {
					Toast.makeText(SaleOutListActivity.this, "没有更多数据！", 1)
			...
			public void onSuccess(Object o) {
				...
				for (InOutStock result : mResult) {
					SaleOutItem maSaleOutItem = new SaleOutItem(result.getCid(),result
							...
							SessionKeeper.getEmail(SaleOutListActivity.this), result.getCount(), result
									.getToNodeName(), result.getCreateTime());
					mSaleOutItems.add(maSaleOutItem);
				}
				mSaleOutAdapter.notifyDataSetChanged();
				mLoading = false;
				Toast.makeText(
						SaleOutListActivity.this,
