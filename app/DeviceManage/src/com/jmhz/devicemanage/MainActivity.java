...
import com.jmhz.devicemanage.manage.DeviceManageActivity;
import com.jmhz.devicemanage.manage.DeviceManageMainActivity;
import com.jmhz.devicemanage.manage.DeviceRepairActivity;
import com.jmhz.devicemanage.manage.DeviceUpdateActivity;
...
import com.jmhz.devicemanage.salesorder.SalesOrderManagementActivity;
...
public class MainActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setImageTextClass(R.id.warehouseManagement,
				...
				R.string.warehouse_management, DeviceManageActivity.class);
		...
		setImageTextClass(R.id.myCenter,
				R.drawable.mycenter_on_off, R.string.my_center,
				PersonCenterActivity.class);
		setImageTextClass(R.id.repairDevice,
				R.drawable.salesordermanagement_on_off,
				R.string.device_repair,
				DeviceRepairActivity.class);
		setImageTextClass(R.id.updateDevice,
				R.drawable.ordermessagemanagement_on_off,
				R.string.device_update, DeviceUpdateActivity.class);
		// setImageTextClass(R.id.myDevices, R.drawable.mycenter_on_off,
		// R.string.myDevices, MyDevicesActivity.class);
		...
		rightButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (TextUtils.isEmpty(getMemberSession())) {
					...
					new DialogUtils(MainActivity.this).showConfirmDialog(
