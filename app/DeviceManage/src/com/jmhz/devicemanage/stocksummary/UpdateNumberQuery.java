...
import com.jmhz.devicemanage.adapter.UpdateAdapter;
import com.jmhz.devicemanage.model.MaintainUpdateItem;

public class UpdateNumberQuery extends BaseActivity {

	private ListView mUpdate =null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_statistic_query);
     	...
     	mClass= Class;
     	mUpdateAdapter = new UpdateAdapter(getListData(), this);
     	mUpdate.setAdapter(mUpdateAdapter);
	}
	...
	private List<MaintainUpdateItem> getListData() {
		...
		maintainUpdateItem.setAlready("14");
		maintainUpdateItem.setWait("16");
	...
	private void initWight() {
		// TODO Auto-generated method stub
		mUpdate = (ListView) findViewById(R.id.device_total_number);
	}

	protected void initializeActivityHead() {
		centreText.setText(R.string.update_number);
