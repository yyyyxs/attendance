...
public class UpdateNumber extends Activity implements OnItemClickListener{
	...
	private CheckBox orFloor=null;
	private CheckBox orClass=null;
	...
	private void initView() {
		...
		btnquery = (Button) findViewById(R.id.update_query);
		btnquery.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(UpdateNumber.this,
						UpdateNumberQuery.class);
