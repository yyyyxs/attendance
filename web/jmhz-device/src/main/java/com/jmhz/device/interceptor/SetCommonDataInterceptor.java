 ...
 */
package com.jmhz.device.interceptor;
...
public class SetCommonDataInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final Logger logger = Logger.getLogger(SetCommonDataInterceptor.class);
    ...
    public void setExcludeParameterPatterns(String[] excludeParameterPatterns) {
        this.excludeParameterPatterns = excludeParameterPatterns.clone();
    }

    public void setExcludeUrlPatterns(final String[] excludeUrlPatterns) {
        this.excludeUrlPatterns = excludeUrlPatterns.clone();
    }
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (request.getAttribute(Constants.CURRENT_URL) == null) {
            ...
            logger.info("CURRENT_URL:|" + extractCurrentURL(request, true) + "|");
        }
