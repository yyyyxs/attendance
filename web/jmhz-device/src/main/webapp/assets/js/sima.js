...
var Sima = function () {
    ...
    // runs callback functions set by Sima.addResponsiveHandler().
    ...
    var handleSidebarMenu = function () {
            ...
            if (sub.is(":visible")) {
                ...
                sub.slideUp(slideSpeed, function () {
                    if ($('body').hasClass('page-sidebar-fixed') == false && $('body').hasClass('page-sidebar-closed') == false) {
                        Sima.scrollTo(the, slideOffeset);
                    }
                    handleSidebarAndContentHeight();
                });
            } else {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            Sima.blockUI(pageContent, false);
            ...
            $.ajax({
                ...
                success: function (res) {
                    Sima.unblockUI(pageContent);
                    pageContentBody.html(res);
                    Sima.fixContentHeight(); // fix content height
                    Sima.initAjax(); // initialize core stuff
                },
    ...
    var handleHorizontalMenu = function () {
        ...
        $('.header').on('click', '.hor-menu a[data-toggle="tab"]', function (e) {     
            ...
            new_link.find("a:first").Simaend('<span class="selected"></span>');
        });
    ...
    var handleTheme = function () {
        ...
        if ( $('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Sima.isRTL() ? 'right' : 'left');
        }
        ...
        var setLayout = function () {
            ...
            if (layoutOption === "boxed") {
                ...
                // set content
                $('.page-container').SimaendTo('body > .container');

                // set footer
                if (footerOption === 'fixed') {
                    $('.footer').html('<div class="container">' + $('.footer').html() + '</div>');
                } else {
                    $('.footer').SimaendTo('body > .container');
                }
            }
        ...
        var setColor = function (color) {
            var color_ = (Sima.isRTL() ? color + '-rtl' : color);
    ...
    return {
        ...
        // wrSimaer function to scroll(focus) to an element
        ...
        // wrSimaer function to  block element(indicate loading)
        ...
        // wrSimaer function to  un-block element(finish loading)
        ...
        //wrSimaer function to update/sync jquery uniform checkbox & radios
