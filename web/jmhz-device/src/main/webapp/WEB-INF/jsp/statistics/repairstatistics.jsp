...
<script>
    ...
    $(function () {
        ...
        var data = [
            { label: "未维修", data: ${unsolvedCount}, color: unsolvedColor},
            { label: "正在维修", data: ${doingCount}, color: doingColor},
            { label: "已修理", data: ${finishCount}, color: finishColor}
        ];
