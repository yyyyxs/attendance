...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><spring:message code="global.navMenu.system" /> - <spring:message code="global.subMenu.audit" /></title>
        <meta name="description" content="System Manager - Login audit" />
    ...
    <body>
                ...
                <div class="main-content">
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><spring:message code="global.subMenu.audit" /></li>
                        </ul><!-- .breadcrumb -->
                    </div>
        ...
        <script src="${ctx}/assets/js/pages/system/audit/auditFun.js"></script>
    </body>
</html>
