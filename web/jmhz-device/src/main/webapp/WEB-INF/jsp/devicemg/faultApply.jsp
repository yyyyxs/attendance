                                    ...
                                    <table class="table table-bordered sima-custom-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="center" colspan="4">
                                                <textarea name="hardshipappeal" id="faultDescribe"
                                                          style="width:800px;height:100px" class="faultDescribe-control"
                                                          style="height: 80px;" placeholder="请详细描述需要维修的地方"></textarea>
                                            </td>
                                        </tr>
...
<script src="${ctx}/assets/js/faultapply.js" type="text/javascript"></script>
<script>
    jQuery(function ($) {
        //权限控制，镇级账号
